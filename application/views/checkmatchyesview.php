...
<b>EL CARNET ES VALIDO - (<?php echo $this->session->flashdata('msg');?>)</b>
</div>

<div style="text-align: center"><br><br>
 <a href="<?php echo site_url('Access') ?>"><button class="btn btn-primary btn-lg" type="button"  >Aceptar</button></a>
</div>
