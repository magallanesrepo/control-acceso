...
<div class="wrapper wrapper-content animated fadeInRight">
                ...
                <div class="col-lg-12">
                    <div class="ibox ">
                        <div class="ibox-title">
                            <h5>Lista de Alicuotas</h5>
                            <div class="ibox-tools">
                              <button class="btn btn-primary btn-sm" type="button" data-toggle="modal" data-target="#modalnewconcept" >Nueva Alicuota</button>
                                    ...
                                    <div class="modal-content animated fadeIn">
                                        <div class="modal-header">
                                           ...
                                           <!-- <i class="fa fa-plus-o modal-icon"></i>-->
                                            <h4 class="modal-title">Nueva Alicuota</h4>
                                            <!--<small>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</small>-->
                                        </div>
                                        <div class="modal-body">
                                          <form action="<?php echo site_url('Aliquotes/create') ?>" method="post">
                                         ...
                                         <div class="col-sm-10"><input type="text" class="form-control" name="name" id="name"></div>
                                                ...
                                                <div class="form-group  row"><label class="col-sm-2 col-form-label">Tasa</label>

                                         <div class="col-sm-10"><input type="number" class="form-control" name="tasa" id="tasa"></div>
                                              </div>
                    ...
                    <tbody>
                        <?php foreach ($result as $row): ?>
                            <tr>
                                ...
                                <td>   <button class="btn btn-info btn-sm" type="button" data-toggle="modal" data-target="#modaleditconcept<?php echo$row->id;
 ...
 <!-- New Bank Modal -->  
                              <div class="modal inmodal" id="modaleditconcept<?php echo$row->id;
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content animated fadeIn">
                                        ...
                                        <div class="modal-body">
                                          <form action="<?php echo site_url('Torres/update') ?>/<?php echo$row->id; ?>" method="post">
                                              
                                              <div class="form-group  row"><label class="col-sm-2 col-form-label">Nombre</label>

                                         <div class="col-sm-10"><input type="text" class="form-control" value="<?php echo$row->nombre;
                                        ...
                                        ?>">
                                         ...
                                         <div class="col-sm-10"><input type="number" class="form-control" name="tasa<?php echo$row->id;
                                        ?>" id="tasa<?php echo$row->id;
                                        ...
                                        <div class="modal-footer">
                                            <div id="idforconfirm_<?php echo$row->id ?>">
                                                <button type="button" class="btn btn-primary" onclick="sendedit(<?php echo$row->id ?>)">Guardar Cambios</button>
                                                    <button type="button" class="btn btn-white" data-dismiss="modal">Cerrar</button>
                                            </div>
                                                </form>
...
//alert(id);
  ...
  //   var type = document.getElementById("concept_type").value; 
    // alert(price);
     //var prop ="all";
   $.ajax({
            url:"<?php echo site_url('Aliquotes/create') ?>",
            method:"POST",
            data:{name:name,valor:tasa},
...
//alert(id);
     var name = document.getElementById("name"+id).value; 
       ...
       var tasa = document.getElementById("tasa"+id).value; 
    // alert(price);
     //var prop ="all";
   $.ajax({
            url:"<?php echo site_url('Aliquotes/update') ?>/"+id,
            method:"POST",
            data:{nombre:name,tasa:tasa},
            success:function(result) { 
