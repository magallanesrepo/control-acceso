...
<b>EL CARNET ES INVALIDO - (<?php echo $this->session->flashdata('msg');?>)</b>
</div>

<div style="text-align: center"><br><br>
 <a href="<?php echo site_url('Access') ?>"> <button class="btn btn-danger btn-lg" type="button" data-toggle="modal" data-target="#modalnewbank" >Aceptar</button></a>
</div>
