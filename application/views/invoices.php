                    ...
                    <div class="ibox ">
                        <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                              <button class="btn btn-primary btn-sm" type="button" data-toggle="modal" data-target="#modalnewconcept" >Generar Aviso de Cobro Mensual</button>
                                <button class="btn btn-default btn-sm" type="button" data-toggle="modal" data-target="#modalnewconcept" >Generar Otros Avisos de Cobro </button>
