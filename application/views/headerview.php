            ...
            <div class="navbar-collapse collapse" id="navbar">
                <ul class="nav navbar-nav mr-auto">
                   ...
                   <li class="dropdown">
                       ...
                       <!-- <ul role="menu" class="dropdown-menu">
                            <li><a href="<?php echo site_url('Control') ?>">Control General</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul role="menu" class="dropdown-menu">
                           <!-- <li><a href="<?php echo site_url('Qinvoice') ?>">Facturas</a></li>-->
                             <li><a href="<?php echo site_url('Qlog') ?>">Diaria</a></li>
                            <li><a href="<?php echo site_url('Qaccess') ?>">Accesos</a></li>
                            <li><a href="<?php echo site_url('Qcards') ?>">Carnets</a></li>
                           <!-- <li><a href="<?php echo site_url('Qclients') ?>">Clientes</a></li>-->
