                ...
                <div class="col-lg-6">
                    <div class="ibox ">
                        <div class="ibox-title">
                            <h5>Búsqueda de Accesos</h5>
                            <div class="ibox-tools">
                            <a href="<?php echo site_url('Qaccess/pdfreport') ?>" target="_blank"> <button class="btn btn-primary btn-sm" type="button" >Generar PDF</button></a>
                        ...
                        <div class="ibox-content">
                            <div class="row">
                                ...
                                <div class="col-sm-10 m-b-xs">
                                  <form action="<?php echo site_url('Qaccess/findlogs') ?>" method="post">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                       ...
                                       <!-- <td><input type="checkbox"  checked class="i-checks" name="input[]"></td>-->
                                        ...
                                        <td><?php echo $row->access_date;?></td><td><?php echo $row->tim;?></td>
