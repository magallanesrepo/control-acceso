...
class Checkmatch extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('Checkmatch_model');
    ...
    public function index() {
      ...
      /* public function create(){
         ...
         public function update($id){
            ...
            $this->Checkmatch_model->updateCards($id);
        ...
        public function delete($id){
            ...
            $this->Checkmatch_model->deleteCards($id);
          //  echo "<div class='alert'>Inscription success</div>";
            //redirect("Concepts");
            ...
            $this->Checkmatch_model->check($code);
